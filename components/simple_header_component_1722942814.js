        ...
        <nav id="nav-bar" class="bg-pink-200 bg-opacity-30 backdrop-filter backdrop-blur-lg border-pink-300 py-2.5 shadow-lg rounded-lg">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div id="menu-toggle-button" class="flex items-center lg:order-2">
                    <button id="collapse-button" data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-purple-600 rounded-lg lg:hidden hover:bg-pink-100 focus:outline-none focus:ring-2 focus:ring-purple-300" aria-controls="mobile-menu-2" aria-expanded="false">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-purple-800 bg-pink-300 bg-opacity-50 rounded-lg lg:bg-transparent lg:text-purple-700 lg:p-0 hover:bg-pink-200 hover:bg-opacity-70 transition-all duration-300" aria-current="page">Exercise Library</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-pink-200 hover:bg-opacity-70 lg:hover:bg-transparent lg:hover:text-purple-900 lg:p-0 transition-all duration-300">Workout Plans</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-pink-200 hover:bg-opacity-70 lg:hover:bg-transparent lg:hover:text-purple-900 lg:p-0 transition-all duration-300">Progress Tracking</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-purple-700 rounded-lg hover:bg-pink-200 hover:bg-opacity-70 lg:hover:bg-transparent lg:hover:text-purple-900 lg:p-0 transition-all duration-300">Community Challenges</a></li>
                    </ul>
                </div>
            </div>
        </nav>
